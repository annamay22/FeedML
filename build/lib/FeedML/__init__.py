...
class datafeeder:
    ...
    def get_fb_data(self, source, sheets, match = None):
        """source: facebook data export .xlsx, sheets: name of sheets needed""" 
        if match == None:
            match = self.match
    ...
    def get_valasztas_data(self,sources):
    ...
    def get_asz_data(self, source, match = None):
        """source: asz info .xlsx"""
        if match == None:
            match = self.match
    ...
    def get_kozmunka(self, source = "https://www.dropbox.com/s/bj9rhpptt0e29zh/kozmunka.csv?dl=1"):
        """publicly available kozmunka data"""
    ...
    def get_terstat_city(self, source = "https://www.dropbox.com/s/3fl9xnpbee91ncz/terstat_city.csv?dl=1"):
        """publicly available ksh data on the city level"""
